...
def main():
    ...
    # Use environment variable for data directory, defaulting to /app/data
    data_dir = os.environ.get("DATA_DIR", "/app/data")
    os.makedirs(data_dir, exist_ok=True)
    
    try:
        # Download the data
        imd.get_data(var_type, args.year, args.year, fn_format='yearwise', file_dir=data_dir)
        
        # Open the downloaded data
        data = imd.open_data(var_type, args.year, args.year, 'yearwise', data_dir)
